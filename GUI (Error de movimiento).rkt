...
(define (VerificarGol)
  (cond ((and (<  PosXBalon 0) (> PosYBalon 260) (< PosYBalon 390));Gol del lado izquierdo
               (GoalString)
...
(define (VerificarDisparo-aux jugador listaJugadores contador)
  ...
  (begin (NuevaVelXBalon (ApuntarX PosXBalon PosYBalon 0 (random 270 370) (ObtenerFuerzaJugador jugador))) (NuevaVelYBalon (ApuntarY PosXBalon PosYBalon 0 (random 270 430) (ObtenerFuerzaJugador jugador))) ))
  ((and (colisionJugadorBalon? jugador) (>= contador 12) (<= contador (- 22 CantDelanteros2)) )
...
(define (MoverJugadores-aux jugador listaJugadores contador)
  (cond ((null? listaJugadores) #f)
        ;;Equipo Rojo
        ((= contador 1) ;;Portero Rojo
               (cond((< (cadr (ObtenerPosJugador jugador)) 260) (CambiarPosJugador jugador (cons (car (ObtenerPosJugador jugador)) 270) 1));;Limite superior
                    ...
                    (else  (CambiarPosJugador jugador (cons (+ (car (ObtenerPosJugador jugador))(ApuntarX (car(ObtenerPosJugador jugador)) (cadr (ObtenerPosJugador jugador)) PosXBalon PosYBalon (ObtenerVelJugador jugador))) (+ (cadr(ObtenerPosJugador jugador)) (ApuntarY (car(ObtenerPosJugador jugador)) (cadr (ObtenerPosJugador jugador)) PosXBalon PosYBalon (ObtenerVelJugador jugador)))) 1))))
        ...
        ((and (<= contador 11) (<= contador (- 11 CantDelanteros1))) ;;Medios rojos
               (cond ((< (car (ObtenerPosJugador jugador)) 400) (CambiarPosJugador jugador (cons 410 (cadr (ObtenerPosJugador jugador))) 1))
                     ((> (car (ObtenerPosJugador jugador)) 800) (CambiarPosJugador jugador (cons 790 (cadr (ObtenerPosJugador jugador))) 1))
                     (else (CambiarPosJugador jugador (cons (+ (car (ObtenerPosJugador jugador))(ApuntarX (car(ObtenerPosJugador jugador)) (cadr (ObtenerPosJugador jugador)) PosXBalon PosYBalon (ObtenerVelJugador jugador))) (+ (cadr(ObtenerPosJugador jugador)) (ApuntarY (car(ObtenerPosJugador jugador)) (cadr (ObtenerPosJugador jugador)) PosXBalon PosYBalon (ObtenerVelJugador jugador)))) 1)))) 
        ...
        ((and (<= contador 11) (<= contador (- 11 CantDelanteros1 CantMedios1))) ;;Defensas azul
               (cond ((< (car (ObtenerPosJugador jugador)) 800) (CambiarPosJugador jugador (cons 810 (cadr (ObtenerPosJugador jugador))) 1))
                     (else (CambiarPosJugador jugador (cons (+ (car (ObtenerPosJugador jugador))(ApuntarX (car(ObtenerPosJugador jugador)) (cadr (ObtenerPosJugador jugador)) PosXBalon PosYBalon (ObtenerVelJugador jugador))) (+ (cadr(ObtenerPosJugador jugador)) (ApuntarY (car(ObtenerPosJugador jugador)) (cadr (ObtenerPosJugador jugador)) PosXBalon PosYBalon (ObtenerVelJugador jugador)))) 1)))) 

        ((and (<= contador 11) (<= contador (- 11 CantDelanteros2))) ;;Medios azul
               (cond ((< (car (ObtenerPosJugador jugador)) 400) (CambiarPosJugador jugador (cons 410 (cadr (ObtenerPosJugador jugador))) 1))
                     ((> (car (ObtenerPosJugador jugador)) 800) (CambiarPosJugador jugador (cons 790 (cadr (ObtenerPosJugador jugador))) 1))
                     (else (CambiarPosJugador jugador (cons (+ (car (ObtenerPosJugador jugador))(ApuntarX (car(ObtenerPosJugador jugador)) (cadr (ObtenerPosJugador jugador)) PosXBalon PosYBalon (ObtenerVelJugador jugador))) (+ (cadr(ObtenerPosJugador jugador)) (ApuntarY (car(ObtenerPosJugador jugador)) (cadr (ObtenerPosJugador jugador)) PosXBalon PosYBalon (ObtenerVelJugador jugador)))) 1)))) 

        ((and (<= contador 11) (<= contador (- 11 CantDelanteros2 CantMedios2))) ;;Delanteros azul
               (cond ((> (car (ObtenerPosJugador jugador)) 400) (CambiarPosJugador jugador (cons 410 (cadr (ObtenerPosJugador jugador))) 1))
                     (else (CambiarPosJugador jugador (cons (+ (car (ObtenerPosJugador jugador))(ApuntarX (car(ObtenerPosJugador jugador)) (cadr (ObtenerPosJugador jugador)) PosXBalon PosYBalon (ObtenerVelJugador jugador))) (+ (cadr(ObtenerPosJugador jugador)) (ApuntarY (car(ObtenerPosJugador jugador)) (cadr (ObtenerPosJugador jugador)) PosXBalon PosYBalon (ObtenerVelJugador jugador)))) 1)))) 

        (else (MoverJugadores-aux (car listaJugadores) (cdr listaJugadores) (+ 1 contador))))
  ) 
